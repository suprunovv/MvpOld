...
public struct Keychain {
    ...
    public static func load(_ key: String) -> String? {
        ...
        if let value = secItemCopy(query).data as? Data {
    ...
    public static func save(_ attributes: [String: AnyObject]) -> (success: Bool, statusCode: OSStatus) {
        let status = secItemAdd(attributes)
    ...
    public static func update(
        _ query: [String: AnyObject],
        attributes: [String: AnyObject]
    ) -> (success: Bool, statusCode: OSStatus) {
